...
protected:
     ...
     * @private
     */
    std::string getColorHelper(QPalette::ColorRole role) const;

    /**
     * @private
     */
    int getColorHelperInt(QPalette::ColorRole role) const;
     ...
     * @private
     */
    void setColorHelper(QPalette::ColorRole role, int rgb);

    /**
     * @private
     */
    void setColorHelper(QPalette::ColorRole role, const QColor& qcolor);

    /**
     * @private
     */
    void setColorHelper(QPalette::ColorRole role, const std::string& color);
     ...
     * @private
     */
    virtual void setStyleSheet(const std::string& styleSheet, bool replace = false);
