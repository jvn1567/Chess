 ...
 * @author Marty Stepp
 * @version 2021/04/12
 * - bug fix for default font family causing warnings on Mac OS X
 * @version 2021/04/09
 * - added sgl namespace
 * @version 2021/04/03
...
public:
    /**
     * The default font family used in text labels if none is provided.
     * If blank, the library will query the OS for its default font.
     */
    static const std::string DEFAULT_FONT_FAMILY;

    /**
     * The default font size used in text labels if none is provided.
     */
    static const int DEFAULT_FONT_SIZE;

    /**
     * Returns a string representing the default font family and size to be
     * used in text labels.
     */
